...
## Последний релиз: 0.6.2

Кратко о недавних изменениях (полная история — в [CHANGELOG.md](CHANGELOG.md)):

- **0.6.2 — релиз безопасности** — исправления по итогам полного аудита: экранирование URL в Markdown-ссылках, ограничение URL действий схемами http(s) с подтверждением, проверки блокировки приложения за постоянное время и устойчивость демона к некорректным данным сервера.
