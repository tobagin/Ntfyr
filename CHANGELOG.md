...
- **Markdown rendering**: Messages published as Markdown are now rendered correctly. ntfy flags these with `content_type: text/markdown`, which the client previously ignored.
...
- **Dependencies**: Updated all Rust dependencies to their latest semver-compatible versions (gtk4/glib 0.22.x, ashpd 0.13.11, hyper 1.10.1, rand 0.10.1, clap 4.6.1, and others).
